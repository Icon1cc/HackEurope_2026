...
import { PaidInvoiceTable } from '@paid-ai/paid-blocks';
...
export default function VendorDetail() {
  ...
  const copy = {
    fr: {
      ...
      aiUsageTitle: 'Utilisation de l\'agent IA',
      aiUsageSubtitle: 'Valeur g\u00e9n\u00e9r\u00e9e par l\'agent pour ce fournisseur',
    },
    en: {
      ...
      aiUsageTitle: 'AI Agent Usage',
      aiUsageSubtitle: 'Value generated by the AI agent for this vendor',
    },
    de: {
      ...
      aiUsageTitle: 'KI-Agent Nutzung',
      aiUsageSubtitle: 'Vom KI-Agenten generierter Wert f\u00fcr diesen Lieferanten',
    },
  }[language];
  ...
  return (
    <div className="flex min-h-screen relative overflow-hidden">
      ...
      <main className="flex-1 lg:ml-64 p-4 pt-20 lg:pt-8 sm:px-6 sm:py-6 lg:p-8 relative z-10">
        ...
        {/* Paid.ai Usage Table */}
        <div
          className="rounded-xl p-4 sm:p-6 mb-6 backdrop-blur-[20px] paid-dark-override"
          style={{
            background: 'rgba(20, 22, 25, 0.6)',
            border: '1px solid rgba(255, 255, 255, 0.1)',
            boxShadow: 'inset 0 1px 0 0 rgba(255, 255, 255, 0.1)',
        ...
        >
          <div className="mb-4">
            ...
            <p className="text-xs sm:text-sm text-[#71717A] mt-1">{copy.aiUsageSubtitle}</p>
          </div>
          <PaidInvoiceTable
            customerExternalId={vendor.id}
            paidStyle={{
              fontFamily: 'Geist Sans, Inter, sans-serif',
              primaryColor: '#FAFAFA',
              secondaryColor: '#71717A',
              containerBackgroundColor: 'transparent',
              tableBackgroundColor: 'rgba(6, 7, 9, 0.8)',
              tableHeaderBackgroundColor: 'rgba(6, 7, 9, 0.9)',
              tabBackgroundColor: 'rgba(255, 255, 255, 0.05)',
              tabActiveBackgroundColor: '#00F2FF',
              tabHoverBackgroundColor: 'rgba(255, 255, 255, 0.08)',
              tableHoverColor: 'rgba(255, 255, 255, 0.03)',
              buttonBgColor: 'rgba(20, 22, 25, 0.6)',
            }}
          />
        </div>
