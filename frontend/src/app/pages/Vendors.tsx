...
export default function Vendors() {
  ...
  const copy = language === 'fr'
    ? {
        ...
        subtitle: 'Tous les emetteurs de factures - clique sur un vendor pour voir son historique',
        searchPlaceholder: 'Rechercher un vendor ou une categorie...',
        tableVendor: 'Vendor',
        tableCategory: 'Categorie',
        tablePaid: 'Payees',
        tablePending: 'En cours',
        tableRejected: 'Rejetees',
        tableTotal: 'Montant total',
        tableTrust: 'Trust Score',
        noResult: 'Aucun vendor ne correspond a votre recherche.',
        paginationSur: 'sur',
