 ...
 */
function signal(eventName, enableCostTracing = false, data) {
    const paidTracer = (0, tracing_js_1.getPaidTracer)();
    ...
    if (!externalCustomerId || !externalProductId) {
        throw new Error(`Missing some of: external_customer_id: ${externalCustomerId}, external_product_id: ${externalProductId}, or token. Make sure to call signal() within trace()`);
    }
