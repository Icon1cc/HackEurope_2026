...
class Traces {
     ...
     *     })
     */
    getTraces(request = {}, requestOptions) {
        return core.HttpResponsePromise.fromPromise(this.__getTraces(request, requestOptions));
    }
    __getTraces() {
        return __awaiter(this, arguments, void 0, function* (request = {}, requestOptions) {
            var _a, _b, _c;
            const { limit, offset, startTime, endTime, externalCustomerId, externalProductId, externalAgentId, metadata } = request;
            const _queryParams = {};
            if (limit != null) {
            ...
            const _response = yield core.fetcher({
                url: (0, url_join_1.default)((_b = (_a = (yield core.Supplier.get(this._options.baseUrl))) !== null && _a !== void 0 ? _a : (yield core.Supplier.get(this._options.environment))) !== null && _b !== void 0 ? _b : environments.PaidEnvironment.Production, "traces"),
                method: "GET",
