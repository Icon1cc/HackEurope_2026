...
export class Customers {
    ...
    __getCostsByExternalId(externalId_1) {
        return __awaiter(this, arguments, void 0, function* (externalId, request = {}, requestOptions) {
            var _a, _b, _c;
            ...
            const _response = yield core.fetcher({
                url: urlJoin((_b = (_a = (yield core.Supplier.get(this._options.baseUrl))) !== null && _a !== void 0 ? _a : (yield core.Supplier.get(this._options.environment))) !== null && _b !== void 0 ? _b : environments.PaidEnvironment.Production, `customers/external/${encodeURIComponent(externalId)}/costs`),
                method: "GET",
                headers: mergeHeaders((_c = this._options) === null || _c === void 0 ? void 0 : _c.headers, mergeOnlyDefinedHeaders({ Authorization: yield this._getAuthorizationHeader() }), requestOptions === null || requestOptions === void 0 ? void 0 : requestOptions.headers),
            ...
            switch (_response.error.reason) {
                ...
                case "timeout":
                    throw new errors.PaidTimeoutError("Timeout exceeded when calling GET /customers/external/{externalId}/costs.");
                case "unknown":
                    throw new errors.PaidError({
                        message: _response.error.errorMessage,
                        rawResponse: _response.rawResponse,
    ...
    __getUsageByExternalId(externalId_1) {
        return __awaiter(this, arguments, void 0, function* (externalId, request = {}, requestOptions) {
            ...
            const _response = yield core.fetcher({
                url: urlJoin((_b = (_a = (yield core.Supplier.get(this._options.baseUrl))) !== null && _a !== void 0 ? _a : (yield core.Supplier.get(this._options.environment))) !== null && _b !== void 0 ? _b : environments.PaidEnvironment.Production, `customers/external/${encodeURIComponent(externalId)}/usage`),
                method: "GET",
                headers: mergeHeaders((_c = this._options) === null || _c === void 0 ? void 0 : _c.headers, mergeOnlyDefinedHeaders({ Authorization: yield this._getAuthorizationHeader() }), requestOptions === null || requestOptions === void 0 ? void 0 : requestOptions.headers),
                queryParameters: _queryParams,
                timeoutMs: (requestOptions === null || requestOptions === void 0 ? void 0 : requestOptions.timeoutInSeconds) != null ? requestOptions.timeoutInSeconds * 1000 : 60000,
            ...
            switch (_response.error.reason) {
                ...
                case "timeout":
                    throw new errors.PaidTimeoutError("Timeout exceeded when calling GET /customers/external/{externalId}/usage.");
                case "unknown":
                    throw new errors.PaidError({
                        message: _response.error.errorMessage,
                        rawResponse: _response.rawResponse,
