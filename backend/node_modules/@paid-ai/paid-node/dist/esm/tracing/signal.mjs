...
import { getPaidTracer, getToken } from "./tracing.mjs";
import { getTracingContext } from "./tracingContext.mjs";
/**
 ...
 */
export function signal(eventName, enableCostTracing = false, data) {
