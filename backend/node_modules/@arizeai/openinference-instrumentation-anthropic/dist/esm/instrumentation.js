...
export class AnthropicInstrumentation extends InstrumentationBase {
    constructor({ instrumentationConfig, traceConfig, tracerProvider, } = {}) {
        ...
        this.oiTracer = new OITracer({
            tracer: this.tracerProvider?.getTracer(INSTRUMENTATION_NAME, VERSION) ??
                this.tracer,
            traceConfig,
        });
    }
        ...
        message.content.forEach((part, index) => {
            ...
            if (part.type === "text") {
                ...
                if (part.source.type === "base64") {
                    ...
                    attributes[`${contentsIndexPrefix}${SemanticConventions.MESSAGE_CONTENT_IMAGE}.type`] = "base64";
                ...
                attributes[`${toolCallIndexPrefix}${SemanticConventions.TOOL_CALL_FUNCTION_NAME}`] = part.name;
