...
import { consumeResponseStreamEvents, getResponsesInputMessagesAttributes, getResponsesOutputMessagesAttributes, getResponsesUsageAttributes, } from "./responsesAttributes";
...
export class OpenAIInstrumentation extends InstrumentationBase {
    constructor({ instrumentationConfig, traceConfig, tracerProvider, } = {}) {
        ...
        this.oiTracer = new OITracer({
            tracer: (_b = (_a = this.tracerProvider) === null || _a === void 0 ? void 0 : _a.getTracer(INSTRUMENTATION_NAME, VERSION)) !== null && _b !== void 0 ? _b : this.tracer,
            traceConfig,
        });
    }
    init() {
        ...
        (original) => {
            return function patchedCreate(...args) {
                ...
                const span = instrumentation.oiTracer.startSpan(`OpenAI Completions`, {
                    kind: SpanKind.INTERNAL,
                    attributes: Object.assign({ [SemanticConventions.OPENINFERENCE_SPAN_KIND]: OpenInferenceSpanKind.LLM, [SemanticConventions.LLM_MODEL_NAME]: body.model, [SemanticConventions.LLM_INVOCATION_PARAMETERS]: JSON.stringify(invocationParameters), [SemanticConventions.LLM_SYSTEM]: LLMSystem.OPENAI, [SemanticConventions.LLM_PROVIDER]: getLLMProvider(this) }, getCompletionInputValueAndMimeType(body)),
                });
                const execContext = getExecContext(span);
                const execPromise = safeExecuteInTheMiddle(() => {
                    return context.with(trace.setSpan(execContext, span), () => {
            ...
            return function patchedEmbeddingCreate(...args) {
                ...
                const span = instrumentation.oiTracer.startSpan(`OpenAI Embeddings`, {
                    ...
                    attributes: Object.assign({ [SemanticConventions.OPENINFERENCE_SPAN_KIND]: OpenInferenceSpanKind.EMBEDDING, [SemanticConventions.EMBEDDING_MODEL_NAME]: body.model, [SemanticConventions.INPUT_VALUE]: isStringInput
                            ...
                            ? MimeType.TEXT
                            : MimeType.JSON, [SemanticConventions.LLM_PROVIDER]: getLLMProvider(this) }, getEmbeddingTextAttributes(body)),
                });
                const execContext = getExecContext(span);
                const execPromise = safeExecuteInTheMiddle(() => {
                    return context.with(trace.setSpan(execContext, span), () => {
            ...
            (original) => {
                return function patchedCreate(...args) {
                    ...
                    const span = instrumentation.oiTracer.startSpan(`OpenAI Responses`, {
                        kind: SpanKind.INTERNAL,
                        attributes: Object.assign(Object.assign({ [SemanticConventions.OPENINFERENCE_SPAN_KIND]: OpenInferenceSpanKind.LLM, [SemanticConventions.LLM_MODEL_NAME]: body.model, [SemanticConventions.INPUT_VALUE]: JSON.stringify(body), [SemanticConventions.INPUT_MIME_TYPE]: MimeType.JSON, [SemanticConventions.LLM_INVOCATION_PARAMETERS]: JSON.stringify(invocationParameters), [SemanticConventions.LLM_SYSTEM]: LLMSystem.OPENAI, [SemanticConventions.LLM_PROVIDER]: getLLMProvider(this) }, getResponsesInputMessagesAttributes(body)), getLLMToolsJSONSchema(body)),
                    });
                    const execContext = getExecContext(span);
                    const execPromise = safeExecuteInTheMiddle(() => {
                        return context.with(trace.setSpan(execContext, span), () => {
                    ...
                    const wrappedPromiseThen = (result) => {
                        const recordSpan = (result) => {
                            ...
                            span.setAttributes(Object.assign(Object.assign({ [SemanticConventions.OUTPUT_VALUE]: JSON.stringify(result), [SemanticConventions.OUTPUT_MIME_TYPE]: MimeType.JSON, 
                                // Override the model from the value sent by the server
                                [SemanticConventions.LLM_MODEL_NAME]: result.model }, getResponsesOutputMessagesAttributes(result)), getResponsesUsageAttributes(result)));
                            span.setStatus({ code: SpanStatusCode.OK });
                            span.end();
                        };
...
function getUsageAttributes(completion) {
    ...
    if (completion.usage) {
        const usageAttributes = {
            ...
            [SemanticConventions.LLM_TOKEN_COUNT_PROMPT_DETAILS_CACHE_READ]: (_a = completion.usage.prompt_tokens_details) === null || _a === void 0 ? void 0 : _a.cached_tokens,
            [SemanticConventions.LLM_TOKEN_COUNT_PROMPT_DETAILS_AUDIO]: (_b = completion.usage.prompt_tokens_details) === null || _b === void 0 ? void 0 : _b.audio_tokens,
            [SemanticConventions.LLM_TOKEN_COUNT_COMPLETION_DETAILS_AUDIO]: (_c = completion.usage.completion_tokens_details) === null || _c === void 0 ? void 0 : _c.audio_tokens,
            [SemanticConventions.LLM_TOKEN_COUNT_COMPLETION_DETAILS_REASONING]: (_d = completion.usage.completion_tokens_details) === null || _d === void 0 ? void 0 : _d.reasoning_tokens,
        };
