...
export function getDocumentAttributes(document, documentIndex, keyPrefix) {
    ...
    const attributes = {};
    if (document.content != null) {
        attributes[`${keyPrefix}.${documentIndex}.${SemanticConventions.DOCUMENT_CONTENT}`] = document.content;
    }
    if (document.id != null) {
    ...
    if (document.score != null) {
        attributes[`${keyPrefix}.${documentIndex}.${SemanticConventions.DOCUMENT_SCORE}`] = document.score;
    }
    return attributes;
}
/**
...
export function getToolAttributes(options) {
    ...
    attributes[SemanticConventions.TOOL_PARAMETERS] =
        (_a = safelyJSONStringify(parameters)) !== null && _a !== void 0 ? _a : "{}";
    return attributes;
}
/**
    ...
    if (options.tokenCount != null) {
        ...
        if (options.tokenCount.promptDetails != null) {
            ...
            if (details.cacheRead != null) {
                attributes[SemanticConventions.LLM_TOKEN_COUNT_PROMPT_DETAILS_CACHE_READ] = details.cacheRead;
            }
            if (details.cacheWrite != null) {
                attributes[SemanticConventions.LLM_TOKEN_COUNT_PROMPT_DETAILS_CACHE_WRITE] = details.cacheWrite;
            }
        }
    }
    // Tools
